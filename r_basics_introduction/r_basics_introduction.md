<!--
dart_module_id: r_basics_introduction
dart_author: Joy Payton
dart_title: R Basics: Introduction
module_id: r_basics_introduction
author: Joy Payton
language: en
mode: Textbook
title: R Basics: Introduction
comment: Are you brand new to R, and ready to get started?  This module teaches concepts and vocabulary related to R, RStudio, and R Markdown.  It also includes some introductory-level hands-on work in RStudio.  This is a good course if you know that you want to use R but haven't ever used it, or you've barely used it and need a refresher on the basics. No prior experience of using R, RStudio, or R Markdown is required for this course.   
...
<figcaption style = "font-size: 0.8em;"> Image taken from *R for Data Science* (https://r4ds.had.co.nz/introduction.html)</figcaption>
