...
This data is saved as a [csv file hosted on GitHub](https://raw.githubusercontent.com/arcus/virtual_library/main/pandas_transform/data/covid_testing.csv).
...
The fake Covid-19 testing data we will use for the rest of this lesson is saved as a [csv file hosted on GitHub](https://raw.githubusercontent.com/arcus/virtual_library/main/pandas_transform/data/covid_testing.csv).
...
```python
covid_testing = pd.read_csv('https://raw.githubusercontent.com/arcus/virtual_library/main/pandas_transform/data/covid_testing.csv')
```

@pyodide_readcsv(covid_testing, "https://raw.githubusercontent.com/arcus/virtual_library/main/pandas_transform/data/covid_testing.csv")
