<!--
dart_title: Python Basics: Functions, Methods, and Variables
dart_module_id: python_basics_variables_functions_methods
...
We'll introduce **functions** and **methods**, the way that things happen in python, and about **variables**, ways of storing information for later use. 
