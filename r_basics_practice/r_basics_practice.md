<!--
dart_module_id: r_basics_practice
dart_author: Rose Hartman
dart_title: R Basics Practice
...
The best way to learn R is by using it! This module provides an opportunity to practice basic R skills on real data. You will use the basics of R coding, data transformation, and data visualization to work with real data. This is a practice module, which means you'll be expected to use commands without them being explained first. Learners should have access to R, either on their own computer or in the cloud, and should be familiar with the following before starting: 
